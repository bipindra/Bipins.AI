...
This directory contains Terraform configuration for deploying the AI Cost Optimization Advisor infrastructure to AWS.
...
- The Terraform configuration automatically builds the Lambda functions before packaging
